...
Learning Rule: Qi(t+1)=α*γ*β*δ*Oi(t)+(1-α*γ*β*δ)*Qi(t) (Full Model)
...
Explanation Files:
	...
	•	runAllSubjects_Simul.m : run optimisation for all subjects in subject file based on simulated behavioural data
